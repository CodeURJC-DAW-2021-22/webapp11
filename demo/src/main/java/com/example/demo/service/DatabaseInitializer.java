...
public class DatabaseInitializer {
	...
	public void init() throws IOException, URISyntaxException {
		...
		Game game1 = new Game("SUEÑOS DE ACERO Y NEON",
		...
		setGameImage(game1, "static/Game images/3DS New Super Mario Bros 2.jpg");
		gameRepository.save(game1);

		Game game2 = new Game("LA VIDA SECRETA DE LA MENTE",
		...
		setGameImage(game2, "static/Game images/DS New Super Mario Bros.jpg");
		gameRepository.save(game2);

		gameRepository.save(new Game("CASI SIN QUERER",
		...
		gameRepository.save(new Game("TERMINAMOS Y OTROS POEMAS SIN TERMINAR",
		...
		gameRepository.save(new Game("LA LEGIÓN PERDIDA",
